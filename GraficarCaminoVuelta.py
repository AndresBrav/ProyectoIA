...
def cargarGraficoVuelta(primerRuta, SegundaRuta):
    ...
    cv2.imshow("Rutas de Vuelta", img)
    cv2.waitKey(0)
...
def GraficarRutas(img, primerRuta, SegundaRuta):
    ...
    if primerRuta == "ruta5LaPampa" and SegundaRuta == "ruta4":
        GraficarRuta5LaPampa(img)
        GraficarRuta4(img)

    if primerRuta == "ruta2LaPampa" and SegundaRuta == "graficarRuta1":
        GraficarRuta2LaPampa(img)
        GraficarRuta1(img)

    """ Ir al mercado San Antonio """
    if primerRuta == "ruta5SanAntonio" and SegundaRuta == "ruta4":
        GraficarRuta5SanAntonio(img)
        GraficarRuta4(img)

    if primerRuta == "ruta3SanAntonio" and SegundaRuta == "graficarRuta1":
        GraficarRuta3SanAntonio(img)
        GraficarRuta1(img)

    """ Ir al Mercado Fidel Aranibar """
    if primerRuta == "ruta4FidelAranibar" and SegundaRuta == "ruta4":
...
# cargarGraficoVuelta("ruta4FidelAranibar","ruta4")

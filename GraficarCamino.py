...
def GraficarCuadrantes(img):
    ...
    NatanielAguirre1(img)
    NatanielAguirre2(img)
...
def FrVal(img):
    pintarvertical(img,650,60,610,30)


def Aroma1(img):
    pintarHorizontal(img,10,50,90,20)
""" + 55 """
def Aroma2(img):
    pintarHorizontal(img,65,50,90,20)

def Aroma3(img):
    pintarHorizontal(img,120,50,90,20) 
""" + 60 """
def Aroma4(img):
    pintarHorizontal(img,180,50,90,20)
def Aroma5(img):
    pintarHorizontal(img,240,50,90,20)
def Aroma6(img):
    pintarHorizontal(img,295,50,90,20)
""" + 60 """ 
def Aroma7(img):
    pintarHorizontal(img,355,50,90,20)
def Aroma8(img):
    pintarHorizontal(img,410,50,90,20)
def Aroma9(img):
    pintarHorizontal(img,465,50,90,20)
""" + 60 """ 
def Aroma10(img):
...
""" calle Brasil """
def Brasil10(img):
    pintarHorizontal(img,525,50,230,20)
def Brasil11(img):
    pintarHorizontal(img,585,50,230,20)

def Brasil12(img):
    pintarHorizontal(img,645,50,230,20)
""" + 55 """ 
def Brasil13(img):
    pintarHorizontal(img,700,50,230,20)
def Brasil14(img):
...
def IsmaelMontes4(img):
    pintarHorizontal(img,180,50,345,20)
def IsmaelMontes5(img):
    pintarHorizontal(img,240,50,345,20)
...
def IsmaelMontes10(img):
    pintarHorizontal(img,525,50,345,20)
def IsmaelMontes11(img):
    pintarHorizontal(img,585,50,345,20)
def IsmaelMontes12(img):
    pintarHorizontal(img,645,50,345,20)
""" + 55 """ 
def IsmaelMontes13(img):
    pintarHorizontal(img,700,50,345,20)
...
""" Calle Punata """
def Punata2(img):
    pintarHorizontal(img,65,50,575,20)
def Punata4(img):
    pintarHorizontal(img,180,50,575,20)
def Punata5(img):
    pintarHorizontal(img,240,50,575,20)
def Punata6(img):
    pintarHorizontal(img,295,50,575,20)
""" + 60 """ 
def Punata7(img):
    pintarHorizontal(img,355,50,575,20)
def Punata8(img):
    pintarHorizontal(img,410,50,575,20)
def Punata9(img):
    pintarHorizontal(img,465,50,575,20)
""" + 60 """ 
def Punata10(img):
    pintarHorizontal(img,525,50,575,20)
def Punata11(img):
    pintarHorizontal(img,585,50,575,20)
def Punata12(img):
    pintarHorizontal(img,645,50,575,20)
""" + 55 """ 
def Punata13(img):
    pintarHorizontal(img,700,50,575,20)
def Punata14(img):
    pintarHorizontal(img,755,50,575,20)
def Punata15(img):
    pintarHorizontal(img,810,50,575,20)
""" + 55 """ 
def Punata16(img):
    pintarHorizontal(img,865,50,575,20)
def Punata17(img):
    pintarHorizontal(img,920,50,575,20)

def Punata19(img):
    pintarHorizontal(img,1040,50,575,20)
def Punata20(img):
    pintarHorizontal(img,1095,50,575,20)
...
def Tarata12(img):
    pintarHorizontal(img,645,50,690,20)
""" + 55 """ 
def Tarata13(img):
    pintarHorizontal(img,700,50,690,20)
def Tarata14(img):
    pintarHorizontal(img,755,50,690,20)
def Tarata15(img):
...
def Ayacucho3(img):
    pintarvertical(img,25,30,140,20)
def Ayacucho4(img):
    pintarvertical(img,25,30,190,20)
def Ayacucho5(img):
    pintarvertical(img,25,25,230,20)
def Ayacucho6(img):
    pintarvertical(img,25,25,270,20)
def Ayacucho7(img):
    pintarvertical(img,25,25,305,20)
def Ayacucho8(img):
    pintarvertical(img,25,25,340,20)
def Ayacucho9(img):
    pintarvertical(img,25,25,375,20)
def Ayacucho10(img):
    pintarvertical(img,25,25,420,20)

def Ayacucho11(img):
    pintarvertical(img,25,25,460,20)
def Ayacucho12(img):
    pintarvertical(img,25,25,495,20)
def Ayacucho13(img):
    pintarvertical(img,25,25,535,20)
def Ayacucho14(img):
    pintarvertical(img,25,25,570,20)
...
def NatanielAguirre3(img):
    pintarvertical(img,310,30,140,20)
def NatanielAguirre4(img):
    pintarvertical(img,310,30,190,20)
def NatanielAguirre5(img):
    pintarvertical(img,310,25,230,20)
def NatanielAguirre6(img):
    pintarvertical(img,310,25,270,20)
def NatanielAguirre7(img):
    pintarvertical(img,310,25,305,20)
def NatanielAguirre8(img):
    pintarvertical(img,310,25,340,20)
def NatanielAguirre9(img):
    pintarvertical(img,310,25,375,20)
def NatanielAguirre10(img):
    pintarvertical(img,310,25,420,20)

def NatanielAguirre11(img):
    pintarvertical(img,310,25,460,20)
def NatanielAguirre12(img):
    pintarvertical(img,310,25,495,20)
def NatanielAguirre13(img):
    pintarvertical(img,310,25,535,20)
...
def EstebanArce3(img):
    pintarvertical(img,485,30,140,20)
def EstebanArce4(img):
    pintarvertical(img,485,30,190,20)
def EstebanArce5(img):
    pintarvertical(img,485,25,230,20)
def EstebanArce6(img):
    pintarvertical(img,485,25,270,20)
def EstebanArce7(img):
    pintarvertical(img,485,25,305,20)
def EstebanArce8(img):
    pintarvertical(img,485,25,340,20)
...
def Mayo5(img):
    pintarvertical(img,770,25,230,20)
def Mayo6(img):
    pintarvertical(img,770,25,270,20)
def Mayo7(img):
    pintarvertical(img,770,25,305,20)
def Mayo8(img):
    pintarvertical(img,770,25,340,20)
def Mayo9(img):
    pintarvertical(img,770,25,375,20)
def Mayo10(img):
    pintarvertical(img,770,25,420,20)

def Mayo11(img):
    pintarvertical(img,770,25,460,20)
def Mayo12(img):
    pintarvertical(img,770,25,495,20)
def Mayo13(img):
    pintarvertical(img,770,25,535,20)
...
def Barrientos14(img):
    pintarvertical(img,1000,25,570,20)
